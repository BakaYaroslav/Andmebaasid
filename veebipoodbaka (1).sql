...
--
-- Host: 127.0.0.1
-- Loomise aeg: Veebr 16, 2026 kell 03:47 PL
...
-- Toimingud
--
CREATE DEFINER=`root`@`localhost` PROCEDURE `10% kogust` ()   BEGIN
SELECT * from stocks;
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `kustutaCustomers` (IN `id` INT)   begin 
...
INSERT INTO `customers` (`customer_id`, `first_name`, `last_name`, `email`, `street`, `city`, `_state`, `zip_code`) VALUES
(2, 'Anna', 'Petrova', 'anna.petrova@email.com', '5 Narva mnt', 'Tallinn', 'Harju', '10117'),
(3, 'Lucas', 'Meyer', 'lucas.meyer@email.com', '8 Bahnhofstrasse', 'Berlin', 'BE', '10115'),
(4, 'Sofia', 'Garcia', 'sofia.garcia@email.com', '22 Calle Mayor', 'Madrid', 'MD', '28013'),
(5, 'Kevin', 'Brown', 'kevin.brown@email.com', '45 Pine Avenue', 'Los Angeles', 'CA', '90001');
...
CREATE TABLE `orders` (
  ...
  `order_status` varchar(30) CHARACTER SET latin7 COLLATE latin7_estonian_cs DEFAULT NULL,
...
(2, NULL, 'hhh', NULL, NULL, NULL, NULL, NULL),
(3, NULL, 'hhh', NULL, NULL, NULL, NULL, NULL);
